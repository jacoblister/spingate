...
prog("4", toNum() + swapAB() + clearA() + set(A2) + toSeg())
prog("5", toNum() + swapAB() + clearA() + set(A2) + set(A0) + toSeg())
prog("6", toNum() + swapAB() + clearA() + set(A2) + set(A1) + toSeg())
prog("7", toNum() + swapAB() + clearA() + set(A2) + set(A1) + set(A0) + toSeg())
prog("8", toNum() + swapAB() + clearA() + set(A3) + toSeg())
prog("9", toNum() + swapAB() + clearA() + set(A3) + set(A0) + toSeg())

prog("A=A+B", toNum() + add4(REG_B, REG_A, C, DP, E) + clear(C) + clear(DP) + clear(E) + clear(D) + toSeg())
prog("A=A-B", toNum() + neg4([B0, B1, B2, B3], C, DP, E, Z, D) + add4(REG_B, REG_A, C, DP, E) + neg4([B0, B1, B2, B3], C, DP, E, Z, D) + clear(C) + clear(DP) + clear(E) + clear(D) + toSeg())
